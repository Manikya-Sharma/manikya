export const projectData = {
  storyphilia: {
    ...
    about:
      "Storyphilia is an AI based web application which\
      generates stories based on user input. It uses GPT-3\
      to generate stories and has a simple and intuitive UI.\
      It also stores the stories in backend and allows easy\
      sharing of stories.",
    techStack: [
      "react",
      "nextjs",
